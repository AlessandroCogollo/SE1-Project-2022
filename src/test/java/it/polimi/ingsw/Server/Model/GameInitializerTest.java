...
class GameInitializerTest {
    ...
    protected static GameInitializer setGameInitializer (int numOfPLayers, int gameMode){
        switch (numOfPLayers){
            case 2:
                ...
                id2[0] = 4;
                id2[1] = 24;
                return new GameInitializer(id2, gameMode);
            case 3:
                int[] id3 = new int[3];
                id3[0] = 4;
                id3[1] = 24;
                id3[2] = 10;
                return new GameInitializer(id3, gameMode);
            case 4:
                int[] id4 = new int[4];
                id4[0] = 1;
                id4[1] = 2;
                id4[2] = 3;
                id4[3] = 4;
                return new GameInitializer(id4, gameMode);
        }
        return null;
    }
    ...
    void getNumberOfPlayers() {
        ...
        for (int i = 2; i <= 4; i++) {
            ...
            assertEquals(i, gInit.getNumberOfPlayers(), "Test " + (i - 1) + " - number of player" + i);
        }
